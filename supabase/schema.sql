...
insert into public.tax_products (id, community_id, slug, category, display_order, name_i18n, description_i18n, icon) values
  ...
  ('tax-america-services:sales-tax', 'tax-america-services', 'sales-tax', 'recurring', 100,
    ...
    'calculator'),
  ('tax-america-services:property-tax', 'tax-america-services', 'property-tax', 'recurring', 110,
    '{"en":"Property Tax","es":"Impuesto Predial"}'::jsonb,
    '{"en":"Real-estate property tax assessment review, appeals, and annual filings.","es":"Revisión de avalúos, apelaciones y declaraciones anuales del impuesto predial."}'::jsonb,
    'house'),
  ('tax-america-services:annual-report', 'tax-america-services', 'annual-report', 'recurring', 120,
    '{"en":"Annual Report","es":"Reporte Anual"}'::jsonb,
    '{"en":"Annual report filings with the Secretary of State to keep your entity in good standing.","es":"Presentación del reporte anual ante la Secretaría de Estado para mantener su entidad en regla."}'::jsonb,
    'document'),
  ('tax-america-services:workers-comp-audit', 'tax-america-services', 'workers-comp-audit', 'recurring', 130,
    '{"en":"Workers'' Compensation Audit","es":"Auditoría de Compensación Laboral"}'::jsonb,
    '{"en":"Annual workers'' compensation premium audit support — payroll classification, audit packet preparation, and dispute response.","es":"Apoyo en la auditoría anual de compensación laboral — clasificación de nómina, preparación del paquete de auditoría y respuesta a disputas."}'::jsonb,
    'shield')
on conflict (id) do nothing;
...
update public.tax_products set long_description_i18n =
  '{"en":"Property tax bills are one of the largest recurring expenses for real-estate owners, and the assessed value the county uses to calculate them is often higher than the property would actually sell for. We review the assessment notice you receive each year, pull comparable sales for the neighborhood, and let you know whether an appeal is worth filing.\n\nWhen we appeal, we prepare the petition packet (forms, photos, sale comparables, valuation worksheet), represent you at the Board of Review or Property Tax Appeal Board hearing, and follow through to the assessed-value adjustment. For multi-property owners we maintain a year-over-year ledger so you can see how each parcel''s assessment is tracking against the rest of the portfolio.\n\nBeyond appeals we handle homestead and senior-exemption applications, the annual income-and-expense statements that some jurisdictions require for income-producing properties, and notice responses for assessment changes or delinquency.","es":"El impuesto predial es uno de los gastos recurrentes más altos para los propietarios de bienes raíces, y el valor catastral que usa el condado para calcularlo suele ser mayor al precio real de venta. Revisamos el aviso de avalúo que recibe cada año, comparamos ventas similares en la zona y le indicamos si vale la pena presentar una apelación.\n\nAl apelar, preparamos el expediente (formularios, fotos, comparables de venta, hoja de valuación), lo representamos ante la Junta de Revisión o la Junta de Apelaciones del Impuesto Predial y damos seguimiento al ajuste del avalúo. Para propietarios con varias propiedades llevamos un historial año tras año para ver cómo se comporta cada predio frente al resto del portafolio.\n\nAdemás de apelaciones gestionamos solicitudes de exención de vivienda y de adultos mayores, los estados anuales de ingresos y gastos que algunas jurisdicciones exigen para propiedades generadoras de ingresos, y las respuestas a notificaciones por cambios de avalúo o morosidad."}'::jsonb
  where id = 'tax-america-services:property-tax' and long_description_i18n = '{}'::jsonb;

update public.tax_products set long_description_i18n =
  '{"en":"Every state requires entities — LLCs, corporations, partnerships, nonprofits — to file an annual (or biennial) report with the Secretary of State to confirm the business is still operating, who the registered agent and officers are, and that the registered office address is current. Miss the deadline and the state will mark the entity ''not in good standing,'' which can block bank loans, contract signings, and in some states administratively dissolve the entity.\n\nWe track every deadline for every entity we manage, prepare the filing with the current officer and address information confirmed with you, pay the state filing fee, and send you the stamped confirmation for your records. For entities in multiple states we maintain a single calendar so a Delaware-formed entity doing business in Connecticut gets both filings on time.\n\nIf an entity has already lapsed when you come to us, we handle the reinstatement filing — usually back-filing the missed reports plus the reinstatement fee — and confirm the entity is restored before closing the engagement.","es":"Cada estado exige que las entidades — LLCs, corporaciones, sociedades, organizaciones sin fines de lucro — presenten un reporte anual (o bienal) ante la Secretaría de Estado para confirmar que el negocio sigue operando, quiénes son el agente registrado y los oficiales, y que la dirección de oficina está vigente. Si se vence el plazo, el estado marca la entidad como ''sin buena reputación,'' lo que puede bloquear préstamos bancarios, contratos y en algunos estados disolver administrativamente la entidad.\n\nLlevamos el seguimiento de cada plazo de cada entidad que administramos, preparamos la presentación con la información actualizada de oficiales y dirección confirmada con usted, pagamos la tarifa estatal y le enviamos la confirmación sellada para sus archivos. Para entidades con presencia en varios estados mantenemos un solo calendario, de modo que una entidad formada en Delaware que opera en Connecticut presente ambos reportes a tiempo.\n\nSi una entidad ya está vencida cuando llega con nosotros, gestionamos el trámite de reinstauración — generalmente presentando los reportes faltantes más la tarifa de reinstauración — y confirmamos que la entidad esté restablecida antes de cerrar el caso."}'::jsonb
  where id = 'tax-america-services:annual-report' and long_description_i18n = '{}'::jsonb;

update public.tax_products set long_description_i18n =
  '{"en":"Every workers'' compensation policy is audited at the end of the policy year so the insurer can adjust the premium based on actual payroll and the classifications the people on it worked in. Audits arrive as a packet of forms, a request for payroll registers by class code, and often a worksheet of subcontractors and certificates of insurance.\n\nWe prepare the audit packet: reconcile payroll registers to the 941s and the year''s W-2 totals, separate overtime premium from straight-time wages (the insurer can''t charge premium on the overtime premium portion in most states), apply officer payroll caps where the state allows, and document any subcontractors who carried their own coverage so they''re removed from the audited payroll.\n\nIf the auditor returns a higher premium that doesn''t match our numbers, we file the dispute within the carrier''s appeal window with the supporting payroll detail. For multi-state employers we also handle the experience-modification (EMOD) review with the rating bureau, since an audit error on this year''s payroll can ripple into next year''s EMOD and three years of higher premiums.","es":"Cada póliza de compensación laboral se audita al final del período de la póliza para que la aseguradora ajuste la prima según la nómina real y las clasificaciones en las que trabajaron las personas cubiertas. La auditoría llega como un paquete de formularios, una solicitud de registros de nómina por código de clasificación y, a menudo, una hoja de subcontratistas y certificados de seguro.\n\nPreparamos el paquete de auditoría: conciliamos los registros de nómina con los formularios 941 y los totales W-2 del año, separamos las horas extras del salario base (la aseguradora no puede cobrar prima sobre la parte de prima por horas extras en la mayoría de los estados), aplicamos los topes de nómina de funcionarios cuando el estado lo permite y documentamos a los subcontratistas que tenían su propia cobertura para que se excluyan de la nómina auditada.\n\nSi el auditor devuelve una prima más alta que no coincide con nuestros números, presentamos la disputa dentro del plazo de apelación de la aseguradora con el detalle de nómina de respaldo. Para empleadores en varios estados también gestionamos la revisión del modificador de experiencia (EMOD) ante la oficina calificadora, ya que un error de auditoría sobre la nómina de este año puede afectar el EMOD del próximo y tres años de primas más altas."}'::jsonb
  where id = 'tax-america-services:workers-comp-audit' and long_description_i18n = '{}'::jsonb;
