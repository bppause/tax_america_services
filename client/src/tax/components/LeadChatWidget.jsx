  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 340 }}>
      ...
      <div style={{
        ...
        {phase === 'done' && (
          <div style={{
            border: '1px solid #2ecc71', borderRadius: 10, padding: 16,
            background: '#f0fff4', textAlign: 'center',
          }}>
            <div style={{ fontSize: 20, marginBottom: 6 }}>✓</div>
            <div style={{ fontWeight: 600, marginBottom: 4 }}>{t('lead.success.heading')}</div>
            <div style={{ fontSize: 13, color: 'var(--tax-muted)' }}>{t('lead.success.body')}</div>
          </div>
        )}
        <div ref={bottomRef} />
      </div>
